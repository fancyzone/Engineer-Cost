...
namespace 施工定额
{
    public partial class Form1 : Form
    {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e) => OpenImportFormFromGrid(dataGridView1, e.RowIndex);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (!Directory.Exists(imageFolder)) imageFolder = Path.Combine(AppContext.BaseDirectory, code);
